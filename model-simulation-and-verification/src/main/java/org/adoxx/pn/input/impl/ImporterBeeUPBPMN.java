...
public class ImporterBeeUPBPMN implements ImporterXmlI {
    ...
    public PetriNet[] generatePetriNet(Document adoxxXml) throws Exception{
        ...
        if(!isCompliant(adoxxXml))
            throw new Exception("The model is not a BPMN in ADOxx BeeUP XML format!");
        ...
        String startQuery = "./*[@class='Start Event (BPMN)']";
        String endQuery = "./*[@class='End Event (BPMN)']";
        String anyTaskQuery = "./*[@class='Task (BPMN)']|./*[@class='Intermediate Event (BPMN)']|./*[@class='Sub-Process (BPMN)']";
        String anyTaskLoopQuery = "./*[@name='Loop type' and text()!='Not specified']";
        String boundaryTaskQuery = "./*[@class='Intermediate Event (BPMN)' and ./INTERREF[@name='Attached to']!='']";
        String andQuery = "./*[@class='Non-exclusive Gateway (BPMN)']|./*[@class='Non-exclusive Gateway (converging) (BPMN)']";
        String xorQuery = "./*[@class='Exclusive Gateway (BPMN)']";
        
        String eventGatewayQuery = "./*[@name='Gateway type']";
        String inclusiveComplexGatewayQuery = "./*[@name='Gateway type']";
        String sequenceFlowQuery = "./*[@class='Subsequent']";
        String messageFlowQuery = "./*[@class='Message Flow (BPMN)']";
        String sequenceFlowExcludeFromToElemList = ""; //Se ci sono sequence flow da/verso una pool allora non li considero 
        String messageFlowExcludeFromToElemList = "Pool (BPMN) Pool (collapsed) (BPMN) Lane (BPMN)"; //Se ci sono messaggi da/verso una pool allora non li considero in quanto per la verifica si assumerebbe che il messaggio sia inviato/ricevuto sempre perci� � come se non ci fosse; se si toglie, vanno mappati a parte un place con un token ed una transizione per ogni messaggio
        ...
        for(int modelIndex=0;modelIndex<bpmnModelElList.getLength();modelIndex++) {
            ...
            for(int i=0;i<startEventNodeList.getLength();i++){
                ...
                NodeList messagesToStartNodeList =  (NodeList) XMLUtils.execXPath(bpmnModelEl, "./*[@class='Message Flow (BPMN)' and (./@instance="+XMLUtils.escapeXPathField(name)+")]", XPathConstants.NODESET);
            ...
            for(int i=0;i<endEventNodeList.getLength();i++){
              ...
              //FIXME: Terminate end events
                ...
                NodeList messegesFromEndNodeList =  (NodeList) XMLUtils.execXPath(bpmnModelEl, "./*[@class='Message Flow (BPMN)' and (./@instance="+XMLUtils.escapeXPathField(name)+")]", XPathConstants.NODESET);
            ...
            for(int i=0;i<anyTaskNodeList.getLength();i++){
                ...
                */
                ...
                NodeList boundConnectorList = (NodeList) XMLUtils.execXPath(bpmnModelEl, "./*[@class='Intermediate Event (BPMN)' and (./*[@name='Attached to']/*/@tobjname="+XMLUtils.escapeXPathField(name)+")]", XPathConstants.NODESET);
